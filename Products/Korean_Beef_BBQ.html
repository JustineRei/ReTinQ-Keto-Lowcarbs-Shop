...
<head>
  ...
  <link rel="stylesheet" href="assets/css/produkto.css">
            ...
            <div class="container-fluid">
                <nav class="m-0" aria-label="breadcrumb">
                    <ol class="breadcrumb m-0">
                      ...
                      <li class="breadcrumb-item  active" aria-current="page">Korean Beef BBQ</li>
                    </ol>
                </nav>     
            </div>
        </div>
            ...
            <div class="row g-9" data-sticky-container>
                ...
                <div class="col-12 col-md-6 col-xl-7">
                    <div class="row g-3" data-aos="fade-right">
                        <div class="col-12">
                            <picture>
                                <img class="image img-fluid" data-zoomable src="assets\images\products\Meat\jhin.jpg" alt="HTML Bootstrap Template by Pixel Rocket">
                            </picture>
                        </div>
                    ...
                    <div class="sticky-top top-5">
                        <div class="pb-3" data-aos="fade-in">
                            <div class="d-flex align-items-center mb-3">
                                <p class="small fw-bolder text-uppercase tracking-wider text-muted m-0 me-4">Meat-Hooray</p>
                            ...
                            <h1 class="mb-1 fs-2 fw-bold">Keto Friendly - Meat-Hooray: Korean Beef BBQ</h1>
                            <div class="d-flex justify-content-between align-items-center">
                                <p class="fs-4 m-0">P369</p>
                            </div>
